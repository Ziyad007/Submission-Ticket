...
function LabPage(props){
    ...
    useEffect(() => {
        // Fetch user info
        fetch(`http://localhost:4000/lab/${props.labName}?teacherEmail=${props.teacherEmail}`)
      ...
      function handleLabStatusToggle(rollNo, currentStatus) {
        ...
        fetch(`http://localhost:4000/lab/${props.labName}/status`, {
          method: 'PUT',
      ...
      const columns = [
        ...
        { field: "lab_attendance", headerName: "Attendance", width: 150,editable:true},
        {
          field: "lab_status",
          headerName: "Status",
          width: 150,
